...
[![Version](https://img.shields.io/badge/version-2.9.6-green)](#)
...
- **Terminal-aware Linux paste** — GNOME Wayland Auto paste uses Ctrl+V for normal fields and Ctrl+Shift+V for terminal focus
...
On Linux/GNOME Wayland, keep the desktop paste mode on **Auto paste** for normal use. Auto paste sends Ctrl+V to normal input fields and switches to Ctrl+Shift+V when the focused app is a terminal. Use the manual terminal or compatibility modes only if a specific app is not detected correctly.
...
10. GNOME Wayland defaults to Auto paste: normal fields receive Ctrl+V, terminal focus detected through AT-SPI receives Ctrl+Shift+V, and the tray menu can switch manually to normal, terminal, or compatibility paste modes
