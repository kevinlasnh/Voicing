...
7. On Linux/GNOME Wayland desktops, leave the PC tray paste mode on Auto paste unless a specific app needs the manual terminal or compatibility mode. If GNOME asks for RemoteDesktop keyboard permission after login or app start, approve it before sending text
