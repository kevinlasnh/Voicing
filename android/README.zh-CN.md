...
7. Linux/GNOME Wayland 桌面端日常保持托盘里的"自动粘贴"即可；自动粘贴会对普通窗口发送 Ctrl+V，对检测到的终端焦点发送 Ctrl+Shift+V；焦点无法确认且近期没有终端命中时会回到 Ctrl+V。如果 GNOME 在登录或 Voicing 启动后弹出 RemoteDesktop 键盘授权，请先允许再发送文字
